...
typedef OSOverride = ({sqlite_open.OperatingSystem os, DynamicLibrary Function() overrideFunc});
...
class SQLiteDatabase {
  ...
  SQLiteDatabase ({
    ...
    _path=path, _name=name, _convert=convert, _reset=reset, _overrides=overrides
  ;
