        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                padding: EdgeInsets.only(left: passwordFieldSidePadding, right: passwordFieldSidePadding),
                child:  TextField(
              ...
              IconButton(
                  onPressed: () {
                    if(password.text.isNotEmpty) {
                      config.authenticateLocal(password.text).then((value) => context.loaderOverlay.hide());
                      context.loaderOverlay.show();
                    }
                  },
                  icon: config.localAuthSet ? const Icon(Icons.lock_open_rounded) : const Icon(Icons.lock_rounded),
              ),
            ],
          ),
        ),
